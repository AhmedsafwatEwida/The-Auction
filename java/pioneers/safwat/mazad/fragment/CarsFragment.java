...
import pioneers.safwat.mazad.activities.RecyclerViewAdapter3itemusers;

/**
 * Created by safwa on 12/11/2017.
 */

public class CarsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void ParseJSonResponse(JSONArray array){
        ...
        for(int i = 0; i<array.length(); i++) {
            ...
            try {
                ...
                GetDataAdapter2.setItemtype("Type:"+json.getString(Image_Cartypr_JSON));
                GetDataAdapter2.setItemengine("Engine:"+json.getString(Image_Engine_JSON));
                GetDataAdapter2.setItembidtime("Bid Time:"+json.getString(Image_Bidtime_JSON));
                ...
                {   GetDataAdapter2.setImagePrice("Price:"+json.getString(Image_Price_JSON1));
                    GetDataAdapter2.setBidWin1("Win:"+json.getString(Bid_Winner_JSON1));}
                ...
                {    GetDataAdapter2.setImagePrice("Price:"+json.getString(Image_Price_JSON2));
                    GetDataAdapter2.setBidWin2("Win:"+json.getString(Bid_Winner_JSON2));}
                ...
                {  GetDataAdapter2.setImagePrice("Price:"+json.getString(Image_Price_JSON3));
                    GetDataAdapter2.setBidWin3("Win:"+json.getString(Bid_Winner_JSON3));}
                ...
                {     GetDataAdapter2.setImagePrice("Price:"+json.getString(Image_Price_JSON4));
                    GetDataAdapter2.setBidWin4("Win:"+json.getString(Bid_Winner_JSON4));}
        ...
        recyclerViewadapter = new RecyclerViewAdapter3itemusers(ListOfdataAdapter, getContext());
