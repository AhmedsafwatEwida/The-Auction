...
import pioneers.safwat.mazad.activities.BidoneProp;
...
public class PropertiesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener  {
   ...
   // RecyclerViewAdapteritemsuser recyclerViewAdapteritemsuser;
    ...
    public void ParseJSonResponse(JSONArray array){
        ...
        for(int i = 0; i<array.length(); i++) {
            ...
            try {
                ...
                GetDataAdapter2.setItembidtime("Bid Time:"+json.getString(Bid_Hour_JSON));
   ...
   /* public void onClickBotonBorrar (View v) {
        Log.d("Recyclerview", "Borrar Click position "+v.getTag());
    }*/
