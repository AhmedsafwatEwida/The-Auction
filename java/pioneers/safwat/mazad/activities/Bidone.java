...
public class Bidone extends AppCompatActivity {
...
//        mViewFlipper.setAutoStart(true);
       ...
       // GetDataAdapter2.setImageTitle(makeu);
        ...
        GetDataAdapter2.setItemStatus("Elapsed:"+statusu);
     ...
     //   GetDataAdapter2.setNoBid("NO.of Bids:"+jsonObject.getString(Image_NoBid_JSON));
      ...
      //  Toast.makeText(getApplicationContext(),engineu , Toast.LENGTH_LONG).show();

      /*  UpdateButtonn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(Bidone.this,BidActivity.class);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Bidone.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Bidone.this).execute();
