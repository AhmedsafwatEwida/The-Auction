...
public class Retreiveone3 extends AppCompatActivity {
...
//            UpdateButtonn=(Button)findViewById(R.id.update);
        ...
        GetDataAdapter2.setImageID(priceu);
     ...
     //   HttpWebCall(TempItem);
        ...
        showwin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Retreiveone3.this,
                        Showwinprice.class);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();*/
                Intent intent = new Intent(Retreiveone3.this,UpdateActivity2.class);
    ...
    public void StudentRecordUpdate(final String ID){
        ...
        class StudentRecordUpdateClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(Retreiveone3.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(Retreiveone3.this,httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Retreiveone3.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Retreiveone3.this).execute();
