...
public class PropFragmentBidActivity2 extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public  void onPlus(View view) {
      ...
      //  TextView oldPrice=(TextView)vview.findViewById(R.id.ImagepriceTextView);
        //String oldyprice=oldPrice.getText().toString();
        //  RecyclerView.ViewHolder vview = recyclerView.getChildAdapterPosition(view);
      //  Toast.makeText(this,  String.valueOf(RecyclerViewItemPosition), Toast.LENGTH_LONG).show();
        if (check == RecyclerViewItemPosition)
        {
            counter = counter + 200;
           // EditText nameEditText = (EditText) vview.findViewById(R.id.newpriceeditable);
        //    Toast.makeText(this,  oldPrice.getText().toString(), Toast.LENGTH_LONG).show();
...
//            nameEditText.setText(String.valueOf(Double.parseDouble(oldyprice) + counter));
            ...
            counter = counter + 200;
                //EditText nameEditText = (EditText) vview.findViewById(R.id.newpriceeditable);
            nameEditText.setText(String.valueOf(Double.parseDouble(ImageTitleNameArrayListForClick.get(RecyclerViewItemPosition)) + counter));
           //     nameEditText.setText(String.valueOf(Double.parseDouble(oldPrice.getText().toString()) + counter));
            newprice = nameEditText.getText().toString();

        }
     //   Toast.makeText(this,  ImageTitleNameArrayListForClick.get(RecyclerViewItemPosition), Toast.LENGTH_LONG).show();
   ...
   /* public  void onPlus(View view) {
    ...
    public void ParseJSonResponse(JSONArray array){
        ...
        recyclerViewadapter = new RecyclerViewAdapteritemsuserBid(ListOfdataAdapter, getApplicationContext());
    ...
    public void HttpWebCallFast(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new PropFragmentBidActivity2.GetHttpResponse(getApplicationContext()).execute();
...
//                progressDialog = ProgressDialog.show(getBaseContext(),"Loading Data",null,true,true);
            }
