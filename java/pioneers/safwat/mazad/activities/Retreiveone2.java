...
public class Retreiveone2 extends AppCompatActivity {
  ...
  // String HTTP_JSON_URL = "http://192.168.43.215/android_login_upload_images/image_retreive2.php";
    ...
    String TempItem;
    String NameHolder,pathholder,Priceholder,AuctionHolder,BidDateHolder,BidWinHolder1,BidWinHolder2,BidWinHolder3,descholder,
    ...
    String yearu,modelu,makeu,warnu,bdateu,btimeu,priceu,winu,engineu,codeu,descu,statusu,millageu,typeu,image1,image2,nameuu,image3;
...
//            UpdateButtonn=(Button)findViewById(R.id.update);
        ...
        GetDataAdapter2.setItemStatus(statusu);
      //  GetDataAdapter2.setItemtype(nameuu);
        ...
        recyclerViewadapter = new RecyclerViewAdapter2itemusers(ListOfdataAdapter, mContext);
       ...
       // showwin = (FloatingActionButton) findViewById(R.id.showwin);
        ...
        deleteitem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Retreiveone2.this,
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();*/
                Intent intent = new Intent(Retreiveone2.this,UpdateActivity2.class);
    ...
    public void StudentRecordUpdate(final String ID){
        ...
        class StudentRecordUpdateClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(Retreiveone2.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(Retreiveone2.this,httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Retreiveone2.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Retreiveone2.this).execute();
                ...
                if(FinalJSonObject != null)
                {
                    ...
                    try {
                       ...
                       //     json = array.getJSONObject(i);
                          ...
                          //  GetDataAdapter2.setNoBid("Bid:"+jsonObject.getString(Image_NoBid_JSON));
