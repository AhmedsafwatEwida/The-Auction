...
public class RecyclerViewAdapter4itemusers extends RecyclerView.Adapter<RecyclerViewAdapter4itemusers.ViewHolder> {
    ...
    public RecyclerViewAdapter4itemusers(List<DataAdapter2> getDataAdapter, Context context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardviewitemuser5, parent, false);
