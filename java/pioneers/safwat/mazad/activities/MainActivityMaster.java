...
//        setSupportActionBar(toolbar);
    ...
    private void loadNavHeader() {
        ...
        Glide.with(this).load(R.drawable.mazadicon)
                .crossFade()
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                  ...
                  /*  case R.id.nav_auctions:
                        ...
                        break;*/
                    case R.id.nav_carsbid:
                        startActivity(new Intent(MainActivityMaster.this, CarsFragmentBidActivity.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_propbid:
                        startActivity(new Intent(MainActivityMaster.this, PropFragmentBidActivity.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_about_us:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(MainActivityMaster.this, AdminLogin.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_privacy_policy:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(MainActivityMaster.this, Contact.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_lang:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(MainActivityMaster.this, AboutUsActivity.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_login:
                        // launch new intent instead of loading fragment
                    ...
                    case R.id.nav_sell:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(MainActivityMaster.this, UploadItemcar.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.set_lang:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(MainActivityMaster.this, LanguageSettings.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_sellcar:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(MainActivityMaster.this, UploadItem.class));
                        drawer.closeDrawers();
                        return true;
                    default:
                        navItemIndex = 0;
