...
public class UploadItem2 extends AppCompatActivity {
        ...
        radiotypeGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (null != rb && checkedId > -1) {
                    ...
                    Toast.makeText(UploadItem2.this, type, Toast.LENGTH_SHORT).show();
...
descrip=itemdescript.getText().toString();
        ...
        UploadImageServer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(UploadItem2.this);
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
               ...
               progressDialog = ProgressDialog.show(UploadItem2.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(UploadItem2.this,string1.toString(),Toast.LENGTH_LONG).show();
