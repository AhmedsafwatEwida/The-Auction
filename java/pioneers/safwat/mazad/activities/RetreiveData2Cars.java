...
public class RetreiveData2Cars extends AppCompatActivity {
  ...
  //  String HTTP_JSON_URL = "http://192.168.43.215/android_login_upload_images/ImageJsonData2.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.retreive_datacars);
      ...
      /*  fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            GestureDetector gestureDetector = new GestureDetector(RetreiveData2Cars.this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                ...
                if(view != null && gestureDetector.onTouchEvent(motionEvent)) {
                   ...
                   nameuu=nameu.getText().toString();
                    ...
                    Toast.makeText(RetreiveData2Cars.this, ImageTitleNameArrayListForClick.get(RecyclerViewItemPosition), Toast.LENGTH_LONG).show();
    ...
    public void JSON_HTTP_CALL(){
        ...
        RequestOfJSonArray = new JsonArrayRequest(AppConfig.HTTP_JSON_ItemsCar,
        ...
        requestQueue = Volley.newRequestQueue(RetreiveData2Cars.this);
    ...
    public void ParseJSonResponse(JSONArray array){
        ...
        for(int i = 0; i<array.length(); i++) {
            ...
            try {
                ...
                GetDataAdapter2.setItembidtime(json.getString(Image_Bidtime_JSON));
