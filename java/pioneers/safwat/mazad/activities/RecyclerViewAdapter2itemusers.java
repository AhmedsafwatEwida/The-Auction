...
public class RecyclerViewAdapter2itemusers extends RecyclerView.Adapter<RecyclerViewAdapter2itemusers.ViewHolder> {
    ...
    public RecyclerViewAdapter2itemusers(List<DataAdapter2> getDataAdapter, Context context){
...
//        Viewholder.ImageTitleTextView.setText(dataAdapterOBJ.getImageTitle());
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            ImagepriceTextView = (TextView) itemView.findViewById(R.id.ImagepriceTextVieww) ;
