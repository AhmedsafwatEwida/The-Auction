...
public class Bidone3 extends AppCompatActivity {
...
//        mViewFlipper.setAutoStart(true);
        ...
        Toast.makeText(getApplicationContext(),TempItem , Toast.LENGTH_LONG).show();
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Bidone3.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Bidone3.this).execute();
