...
public class RecyclerViewAdapter2itemusersprop extends RecyclerView.Adapter<RecyclerViewAdapter2itemusersprop.ViewHolder> {
    ...
    public RecyclerViewAdapter2itemusersprop(List<DataAdapter2> getDataAdapter, Context context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview4itemuserprop, parent, false);
      ...
      // mViewFlipper.setFlipInterval(4000);
       ...
       mViewFlipper.setOnClickListener(new View.OnClickListener() {
           ...
           /*    mViewFlipper.setInAnimation(context,R.anim.in_from_left);
               mViewFlipper.setOutAnimation(context,R.anim.in_from_right);
               mViewFlipper.setAnimation(mViewFlipper.getInAnimation());*/
...
//        Viewholder.ImageTitleTextView.setText(dataAdapterOBJ.getImageTitle());
    ...
    //    Viewholder.ImagebidwinTextView.setText(dataAdapterOBJ.getBidWin());
        ...
        Viewholder.ImageengineTextView.setText(dataAdapterOBJ.getItemproptype());
