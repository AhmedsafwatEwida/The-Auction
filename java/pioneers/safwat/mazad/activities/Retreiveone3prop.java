...
public class Retreiveone3prop extends AppCompatActivity {
...
//            UpdateButtonn=(Button)findViewById(R.id.update);
        ...
        showwin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Retreiveone3prop.this,
                        Showwinprice.class);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();*/
                Intent intent = new Intent(Retreiveone3prop.this,UpdateActivity2.class);
    ...
    public void StudentRecordUpdate(final String ID){
        ...
        class StudentRecordUpdateClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(Retreiveone3prop.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(Retreiveone3prop.this,httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Retreiveone3prop.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Retreiveone3prop.this).execute();
