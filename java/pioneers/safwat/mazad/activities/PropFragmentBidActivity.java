...
public class PropFragmentBidActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public  void  imagedetail (View view){
        ...
        Intent i = new Intent(getApplication(), BidoneProp.class);
   ...
   /* public  void onPlus(View view) {
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
         ...
         //       pDialog = ProgressDialog.show(getApplicationContext(),"Loading Data",null,true,true);
          ...
          //      pDialog.dismiss();
                ...
                new PropFragmentBidActivity.GetHttpResponse(getApplicationContext()).execute();
    ...
    public void StudentRecordUpdate( String ID,  String S_price, String S_price1, String S_price2, String S_price3, String S_price4
        ...
        class StudentRecordUpdateClass extends AsyncTask<String,Void,String> {
            ...
            // progressDialog = ProgressDialog.show(PropFragmentBidActivity.this,"Loading Data",null,true,true);
            }
