...
public class CarsFragmentBidActivity3 extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void HttpWebCallFast(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new CarsFragmentBidActivity3.GetHttpResponse(getApplicationContext()).execute();
