...
public class RecyclerViewAdapteritemsuserBid extends RecyclerView.Adapter<RecyclerViewAdapteritemsuserBid.ViewHolder> {
    ...
    public RecyclerViewAdapteritemsuserBid(List<DataAdapter> getDataAdapter, Context context){
